...
<div class="container">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header bg-light">
                                    <h5 class="modal-title"><i class="fa fa-calendar-times"></i> Excuse Request</h5>
                                ...
                                <div class="modal-body">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-6">
                                            <p class="text-muted small mb-1">Absence Date</p>
                                            <p class="font-weight-bold"><?= date('l, F j, Y', strtotime($r['absence_date'])) ?></p>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-6">
                                    ...
                                    <?php if ($r['status'] === 'pending'): ?>
                                        <hr>
                                        <form method="post" action="<?= base_url('admin/process_excuse') ?>">
    ...
    <?php else: ?>
        <div class="alert alert-info">
            <i class="fa fa-info-circle"></i> No excuse requests found
