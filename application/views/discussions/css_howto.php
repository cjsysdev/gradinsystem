...
<p>This is a paragraph.</p>
                    ...
                    <p>External styles are defined within the
...
margin-left: 20px;
                    ...
                    <p>Internal styles are defined within the <?= htmlspecialchars('<style>') ?> element, inside the <?= htmlspecialchars('<head>') ?> section of an HTML page:
                    </p>
...
<p style="color:red;">This is a paragraph.</p>
                    ...
                    <pre><code class="language-css"><?= htmlspecialchars('
h1
{
color: navy;
}') ?>
</code></pre>
                    <p>Assume that an external style sheet has the following style for the
                        <?= htmlspecialchars('<h1>') ?> element:</p>
                    <pre><code class="language-css">
<?= htmlspecialchars('
h1
{
...
') ?>
                    ...
                    <!-- Try it Yourself example -->
                    <p>However, if the internal style is defined before the link to the external style sheet, the
                        <?= htmlspecialchars('<h1>') ?> elements will be
                        "navy":</p>
                    <pre><code class="language-html">
<?= htmlspecialchars(
'<head>
