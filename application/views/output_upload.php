...
<div class="container">
    <div class="dashboard">
        ...
        <!-- <div class="row text-center mb-2">
            ...
            <div class="col">
                <button class="btn btn-outline-secondary">Activities</button>
            </div>
        </div> -->
        ...
        <form action="upload_activity" method="POST" enctype="multipart/form-data">
            <div class="category-btns row">
                <div class="col-12 form-section p-2">
                    ...
                    <input type="number" class="form-control" id="activities-score" name="score" placeholder="Enter Activity Score">
                </div>
                <div class="col-12 form-section p-2">
